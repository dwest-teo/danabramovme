  ...
  window.JEEFACEFILTERAPI = (function() {
        ...
        for (a = 0; a < y.i; ++a)
          if (-1 !== y.K.indexOf(a)) {
            ...
            if (b.ua < v.Ua) H.$ && (d.rz = 0);
              ...
              for (var k = 0; k < v.ya; ++k)
                b.jb[k] = v.nc[k](F(2, h, k, 0, 1));
              f.La = b.x - d.x;
              f.Ma = b.y - d.y;
              f.Ka = b.M - d.s;
              f.Ha = b.Wa - d.rx;
    ...
    function fa() {
      return la.some(function(a, b) {
        ...
        if (
          b.xa > a.xa ||
          3 > a.xa ||
          L(b.x / 2, b.M, a.x / 2, a.M) < v.yb * b.M
        )
          return !1;
        var d = ea / P;
    ...
    return {
      init: function(a) {
        ...
        for (var d = 0; d < y.i; ++d)
          Ca.push(new Float32Array(v.Fc)), Da.push(0);
